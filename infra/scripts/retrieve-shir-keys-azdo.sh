...
echo "WARNING: This script uses an undocumented API (.proxy.fabric.azure.com) which may change in future releases."
...
curl --request PUT \
  --url "https://$PURVIEW_ACCOUNT_NAME.proxy.fabric.azure.com/integrationRuntimes/$PURVIEW_SHIR_NAME?api-version=2020-12-01-preview" \
