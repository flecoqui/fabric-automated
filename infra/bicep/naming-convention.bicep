...
output searchName string = 'search${baseName}'
...
output datagwVMName string = 'gwvm${baseName}'
output datagwVMLoginSecretName string = 'DATA-GATEWAY-LOGIN'
output datagwVMPassSecretName string = 'DATA-GATEWAY-PASSWORD'
output datagwVMRecoveryKeySecretName string = 'DATA-GATEWAY-RECOVERY-KEY'
output datagwCertificateSecretName string = 'DATA-GATEWAY-CERTIFICATE'
output datagwCertificatePasswordSecretName string = 'DATA-GATEWAY-CERTIFICATE-PASSWORD'
output datagwCertificateName string = 'DATA-GATEWAY-SP-CERT'
output datagwAppName string = 'app${baseName}'
