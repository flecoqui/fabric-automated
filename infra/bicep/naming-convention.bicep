...
output fabricShirKeyName string = 'DATAGW-KEY'
output fabricShirVMLoginSecretName string = 'DATAGW-VM-LOGIN'
output fabricShirVMPassSecretName string = 'DATAGW-VM-PASSWORD'
