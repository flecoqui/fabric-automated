...
#
# 4. Upload the this file privatepurviewlineage.py into Synapse ADLS Storage Account in the
# container under  fabric folder
#
# 5. Create a Synapse Job with the command below pointing to the uploaded file
# abfss://[ADLSContainerName]@[ADLSStorageAccountName].dfs.core.windows.net/
# fabric/privatepurviewlineage.py
# 6. Publish the new Synapse Job
# 7. Submit the new Synapse Job
#
...
SP_TENANT_ID_SECRET_NAME = "SP-TENANT-ID"  # noqa: S105
SP_CLIENT_ID_SECRET_NAME = "SP-CLIENT-ID"  # noqa: S105
SP_SECRET_SECRET_NAME = "SP-SECRET"  # noqa: S105
...
print("✓ Fabric Custom Lineage created successfully")  # noqa: T201
